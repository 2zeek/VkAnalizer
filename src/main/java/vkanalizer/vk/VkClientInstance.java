...
public interface VkClientInstance {
    ...
    GetListResponse getReposts(Integer id) throws ClientException, ApiException, InterruptedException;
    List<GroupFull> getGroupInfo(List<String> ids) throws ClientException, ApiException, InterruptedException;
